...
win32:
{
CONFIG(debug, debug|release): LIBS += -L$$PWD/../../../bin/16.0/x64/DebugDLL/ -lcartotype -L$$PWD/../../main/platform/qt/CartoTypeQtMapRenderer/build64/debug -lCartoTypeQtMapRenderer
else:CONFIG(release, debug|release): LIBS += -L$$PWD/../../../bin/16.0/x64/ReleaseDLL/ -lcartotype -L$$PWD/../../main/platform/qt/CartoTypeQtMapRenderer/build64/release -lCartoTypeQtMapRenderer
}
