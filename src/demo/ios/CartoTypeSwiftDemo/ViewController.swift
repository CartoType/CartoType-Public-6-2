...
//  CartoTypeSwiftDemo
//
//  Copyright © 2016-2020 CartoType Ltd. All rights reserved.
//
...
class ViewController: CartoTypeViewController, UISearchBarDelegate, CLLocationManagerDelegate
    ...
    func createUI()
        ...
        if (m_toolbar == nil)
            ...
            let toolbar_items = [ m_find_button, m_view_button, m_route_button, m_navigate_button ]
    ...
    func chooseMapObject(_ aMapObjectArray : NSMutableArray)
        ...
        for object in aMapObjectArray
            ...
            alert.addAction(UIAlertAction(title: address, style: .default, handler:
                { _ in
                self.m_framework.insertCopy(of: map_object, map: 0, layerName: "found", radius: 20, radiusCoordType: MapMeterCoordType, id: UnsafeMutablePointer<UInt64>(&self.m_found_item_id), replace: true)
