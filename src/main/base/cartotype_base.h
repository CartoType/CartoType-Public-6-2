...
class TOutlinePoint: public TPoint
    ...
    /** Create an outline point, specifying coordinates. */
...
/** A constant to convert radians to degrees: the number of degrees in a radian. */
constexpr double KRadiansToDegreesDouble = 180.0 / KPiDouble;
/** A constant to convert degrees to radians: the number of radians in a degree. */
