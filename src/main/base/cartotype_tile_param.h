...
class TTileParam
    ...
    /** Creates tile parameters, supplying the tile name format (see iTileNameFormat), zoom levels (see iZoomLevels), and other optional parameters. */
    ...
    /** Sets the extent used for a tile accessor to an inclusive range of tiles. */
